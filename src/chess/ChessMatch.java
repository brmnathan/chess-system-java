...
public class ChessMatch {
	...
	public boolean[][] possibleMpves(ChessPosition sourcePosition) {
	...
	public ChessPiece replacePromotedPiece(String type) {
		...
		if (!type.equals("B") && !type.equals("N") && !type.equals("R") && !type.equals("Q"))
			throw new InvalidParameterException("Invalid typee for promotion");
	...
	private ChessPiece king(Color color) {
		...
		throw new IllegalStateException("There is no " + color + " king on he board");
	}
